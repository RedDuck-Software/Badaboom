...
CMD ["sh", "-c", "dotnet Indexer.dll CrimeChain ${LOG_FOLDER}/log.log ${LOG_CRITICAL_FOLDER}/log.critical.log $RPC_URL $INDEX_INNER_CALLS $BLOCK_QUEUE_SIZE $INDEX_START_BLOCK"]
