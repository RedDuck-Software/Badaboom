...
ENTRYPOINT ["sh", "-c", "dotnet Indexer.dll CrimeChain ${LOG_FOLDER} ${LOG_CRITICAL_FOLDER} $RPC_URL $INDEX_INNER_CALLS $BLOCK_QUEUE_SIZE $INDEX_START_BLOCK $START_INDEXING"]
